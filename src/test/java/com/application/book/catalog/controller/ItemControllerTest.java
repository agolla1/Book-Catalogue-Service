...
import com.application.book.catalog.common.AbstractIntegrationTest;
import com.application.book.catalog.common.TestHelper;
import com.application.book.catalog.domain.CreateProductModel;
...
class ItemControllerTest extends AbstractIntegrationTest {
    ...
    void shouldGetAllProducts() {
        given().contentType(ContentType.JSON)
                ...
                .then()
                .statusCode(200)
                .body("data", hasSize(bookItems.size()))
                .body("totalElements", is(bookItems.size()))
